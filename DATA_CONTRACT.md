...
| `.github/*` | GitHub Copilot agents, prompts, skills, hooks, workflows, and repo instructions |
| `.vscode/settings.json` | Workspace settings that enable Copilot prompt/instruction files |
