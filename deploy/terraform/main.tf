...
provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      ManagedBy      = "terraform"
      # Links resources to the existing CareerOps Application in Resource Groups
      awsApplication = "arn:aws:resource-groups:ap-southeast-2:302388404732:group/CareerOps/07l7h5h56a17el3u2zn4rybbz2"
    }
  }
}
...
resource "aws_security_group" "worker" {
  ...
  description = "ECS worker and scanner tasks - egress only"
  vpc_id      = aws_vpc.main.id
