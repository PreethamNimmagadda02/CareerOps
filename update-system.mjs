...
const CANONICAL_REPO = 'https://github.com/ORION2809/carrer-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/ORION2809/carrer-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/ORION2809/carrer-ops/releases/latest';
