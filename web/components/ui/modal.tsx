...
export function Modal({ open, onClose, title, subtitle, children, className }: ModalProps) {
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="absolute inset-0 animate-fade-in bg-background/70 backdrop-blur-sm" onClick={onClose} />
      <div
        className={cn(
          "relative z-10 flex max-h-[88vh] w-full max-w-3xl animate-scale-in flex-col overflow-hidden rounded-xl border border-border bg-card shadow-2xl",
          className,
        )}
      >
