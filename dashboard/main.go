...
import (
	...
	"github.com/ORION2809/carrer-ops/dashboard/internal/data"
	"github.com/ORION2809/carrer-ops/dashboard/internal/theme"
	"github.com/ORION2809/carrer-ops/dashboard/internal/ui/screens"
)
...
func main() {
	...
	// Auto-detect career-ops root if run from dashboard directory
	if careerOpsPath == "." {
		if _, err := os.Stat("data/applications.md"); os.IsNotExist(err) {
			if _, err := os.Stat("../data/applications.md"); err == nil {
				careerOpsPath = ".."
			}
		}
	}
