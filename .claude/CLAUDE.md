...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-18 (commit 9673a22). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.81/10 avg, hotspot health 6.68/10 (stable), worst `web/components/launch-pad.tsx` at 2.77/10 · maintainability 9.62/10 · performance risk 12 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
