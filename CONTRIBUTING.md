...
Thanks for your interest in contributing! Career-Ops supports both Claude Code and GitHub Copilot, and you can use either path for development.
...
- Report bugs via [Issues](https://github.com/ORION2809/carrer-ops/issues)
...
- Keep modes language-agnostic when possible (Claude Code and Copilot both handle EN and ES)
...
- [Open an issue](https://github.com/ORION2809/carrer-ops/issues)
