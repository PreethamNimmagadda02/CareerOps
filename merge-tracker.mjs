...
// Canonical states (English — matching states.yml) and aliases
...
function validateStatus(status) {
  ...
  // Aliases (Spanish + common variations)
  const aliases = {
    'evaluada': 'Evaluated', 'evaluar': 'Evaluated', 'verificar': 'Evaluated', 'condicional': 'Evaluated', 'hold': 'Evaluated',
